...
int main(){
    ...
    Armour a[6]={Armour(1, 1, "Leather"), Armour(2, 1, "Gold"), Armour(3, 1, "Chain"), Armour(4, 2, "Diamond"), Armour(5, 2, "Iron"), Armour(6, 2, "Netherite")}; //initialising array of armour objects
    ...
    a[choice-1].setType(1);
    cout << "your armour now has type: " << a[choice-1].getType()<<endl;                                    //testing setType and getType

    cout << "changing type to 2" << endl;
    a[choice-1].setType(2);
    cout << "your armour now has type: " << a[choice-1].getType()<<endl;

    cout << "changing type to 3" << endl;
    a[choice-1].setType(3);
    cout << "your armour now has type: " << a[choice-1].getType()<<endl;
